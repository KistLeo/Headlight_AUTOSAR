...
bool CanIfInitialized = true; // Giả lập trạng thái khởi tạo CanIf

/* Danh sách Rx PDU giả lập */
CanIf_RxPduConfigType RxPduConfigs[] = {
    { .CanId = 0x123, .Hoh = 1, .ReadDataEnabled = true, .Buffer = {0}, .BufferSize = 0 },
    { .CanId = 0x456, .Hoh = 2, .ReadDataEnabled = true, .Buffer = {0}, .BufferSize = 0 }
};

/* Cấu hình tổng thể CanIf */
CanIf_ConfigType CanIfConfig = {
    .RxPduCount = 2,
    .RxPduConfig = RxPduConfigs
};
